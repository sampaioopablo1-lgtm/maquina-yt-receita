# Guia do Closer — como trabalhar no CRM (versão 23/09/2026)

## Onde você entra

O SDR marca a reunião no calendário **"Reunião com closer"**. O lead chega
sozinho na etapa **REUNIÃO DE DIAGNÓSTICO**, já com a **Nota de qualificação**
calculada e o formulário preenchido.

## Seu fluxo

| Momento | O que fazer no CRM | O que o sistema faz |
|---|---|---|
| Antes da reunião | Ler a nota de qualificação e o formulário no contato | — |
...
- Nunca devolva o lead para CONECTAR: se ele precisar de nova conversa com o SDR,
  avise o gestor.
