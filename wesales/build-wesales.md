...
| `Leads novos — 7 dias` (nova, F-10) | `Contagem de contatos com "Date Created" nos últimos 7 dias` | Tendência de entrada: separa "dia fraco" de "parou". Medido em 22/09: mais de 22h sem lead novo (número corrigido — a abertura do F-10 tinha escrito ~46h por erro de conta, ver `ROADMAP-SALES-ENGAGEMENT.md`), e nenhum alerta existia para dizer isso |
