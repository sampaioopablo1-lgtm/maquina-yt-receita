...
| 6b | **Publicar o `Espelho de Etapa`** (hoje em rascunho) — e, ao publicar, conferir na tela se o gatilho de oportunidade etiqueta o acervo ou só mudança futura | 8 workflows publicados já testam as tags que só ele aplica. Enquanto ele não sobe, a condição lê tag ausente e vai pelo "não" — o mesmo desvio silencioso que o patch consertou no papel (seção 2.32). É um clique |
