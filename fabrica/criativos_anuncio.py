...
PECAS = [
    ...
    ("TF02_falta_cliente_novo", "topo", "empty shop counter waiting",
    ...
    ("TF06_tirar_do_proprio_bolso", "topo", "worried man calculator bills",
    ...
    ("BF04_anuncio_no_ar", "fundo", "laptop dashboard analytics desk",
    ...
    ("BF06_para_quem_e", "fundo", "small business storefront owner",
