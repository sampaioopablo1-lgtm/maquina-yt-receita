#!/usr/bin/env python3
"""setiap-level-006 — "Gaji Naik Tapi Uang Tetap Habis".
...
# ---------------------------------------------------------------------------
from blocos_006 import BLOCOS

SHORT = [
 ("titulo", "Utangmu", "punya batas resmi",
  "Utang pinjolmu punya batas resmi, dan hampir tidak ada yang menyebutnya."),
 ("item", "Bunga plus denda", "maksimal seratus persen dari pokok",
  "Bunga ditambah denda tidak boleh melebihi seratus persen dari pokok pinjaman."),
 ("titulo", "Artinya", "maksimal dua kali lipat",
  "Artinya kalau kamu pinjam lima juta, maksimal yang sah ditagih darimu sepuluh juta. Berapa pun bulan yang sudah lewat."),
 ("item", "Dan batas itu", "tercapai di hari kelima ratus",
  "Pada nol koma dua persen per hari, batas itu tercapai di sekitar hari kelima ratus. Setelah itu angkanya membeku."),
 ("cta", "Empat angka lengkapnya", "di video panjangnya",
  "Empat angkanya, dan cara memeriksa tagihanmu sendiri, ada di video panjangnya."),
]
