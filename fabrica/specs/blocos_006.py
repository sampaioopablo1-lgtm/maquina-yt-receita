...
BLOCOS = [
 ("Angka yang tidak pernah disebut", [
  ...
  ("titulo", "Perbedaannya penting", "dan sering dikaburkan",
   "Perbedaan antara keduanya penting. Yang satu meminta kamu bertaruh pada apa yang mungkin terjadi. Yang lain memberi kamu angka yang sudah tertulis, dan bisa kamu pegang hari ini juga."),
  ...
  ("titulo", "Rasa takut", "sebagian besar datang dari tidak tahu",
   "Sebagian besar tekanan yang dirasakan orang yang menunggak bukan datang dari besarnya angka. Ia datang dari tidak tahu di mana angka itu berhenti."),
  ("item", "Utang yang punya ujung", "berbeda dari yang tidak",
   "Utang yang punya ujung yang bisa dihitung adalah masalah keuangan. Utang yang terasa tumbuh tanpa batas menjadi masalah lain lagi, dan yang kedua itu jauh lebih sulit ditanggung."),
  ("titulo", "Video ini", "memberi ujung itu",
   "Yang video ini kerjakan hanyalah memberi ujung itu kembali, dengan angka yang bisa diperiksa dan tanggal yang bisa dihitung."),
 ...
 ("Bunga harian, dan berapa persisnya", [
  ...
  ("titulo", "Sekarang ubah jadi rupiah", "supaya terasa",
   "Persen per hari sulit dirasakan. Mari ubah jadi rupiah, dengan angka yang paling sering dipinjam orang."),
  ("item", "Pinjam lima juta", "lima ribu rupiah per hari",
   "Pinjaman lima juta rupiah dengan bunga nol koma satu persen per hari berarti lima ribu rupiah setiap hari."),
  ("item", "Dalam tiga puluh hari", "seratus lima puluh ribu",
   "Dalam tiga puluh hari itu menjadi seratus lima puluh ribu rupiah. Dalam sembilan puluh hari, empat ratus lima puluh ribu."),
  ("titulo", "Lima ribu sehari", "terdengar kecil",
   "Lima ribu rupiah sehari terdengar kecil karena kepala membandingkannya dengan harga satu gelas kopi. Tapi ia tidak berhenti seperti kopi berhenti."),
  ...
  ("item", "Konsekuensi praktisnya", "periksa jenis pinjamanmu",
   "Konsekuensi praktisnya sederhana: periksa di kontrakmu pinjamanmu tercatat sebagai apa. Nama jenisnya menentukan batas mana yang berlaku untukmu."),
 ...
 ("Denda, yang dihitung terpisah", [
  ...
  ("item", "Kembali ke lima juta", "sepuluh ribu per hari",
   "Kembali ke contoh lima juta rupiah. Menunggak berarti sepuluh ribu rupiah per hari, bukan lima ribu."),
  ("item", "Sebulan menunggak", "tiga ratus ribu",
   "Satu bulan menunggak menambah tiga ratus ribu rupiah. Tiga bulan menunggak menambah sembilan ratus ribu."),
  ("titulo", "Itu sebabnya", "satu bulan pertama menentukan",
   "Itu sebabnya bulan pertama keterlambatan menentukan begitu banyak. Bukan karena dendanya besar di bulan itu, melainkan karena setelahnya lajunya berlipat dan tidak turun lagi sendiri."),
 ...
 ("Pagar yang hampir tidak ada yang tahu", [
  ...
  ("titulo", "Satu kalimat", "kamu tidak berutang tiga kali lipat",
  ...
  ("item", "Pinjam dua juta", "maksimal empat juta",
   "Pinjam dua juta rupiah, maksimalnya empat juta. Pinjam sepuluh juta, maksimalnya dua puluh juta. Aturannya sama di semua nominal."),
  ...
  ("titulo", "Dan ini terjadi", "lebih sering dari yang disangka",
   "Dan itu terjadi lebih sering dari yang disangka, terutama pada utang lama yang sudah berpindah tangan beberapa kali dan sudah kehilangan catatan awalnya."),
  ("item", "Batas ini juga", "menutup pintu bunga berbunga",
   "Batas ini juga menutup satu pintu lain: dengan plafon di seratus persen, tidak ada ruang untuk tagihan yang berlipat tanpa akhir, sebesar apa pun keterlambatannya."),
 ...
 ("Kapan batas itu tercapai", [
  ...
  ("titulo", "Dua angka ini", "adalah penggarisnya",
  ...
  ("item", "Cara memakainya", "hitung mundur dari tanggal cair",
   "Cara memakainya sederhana. Hitung berapa hari sudah lewat sejak dana cair, lalu bandingkan dengan lima ratus atau seribu, tergantung status pembayaranmu."),
  ("titulo", "Kalau sudah lewat", "tagihannya patut dipertanyakan",
   "Kalau jumlah harinya sudah jauh melewati angka itu dan tagihan masih naik setiap bulan, ada sesuatu yang tidak sesuai aturan dalam tagihan itu."),
  ("item", "Dan bukan kamu", "yang harus membuktikan sebaliknya",
   "Dan yang perlu menunjukkan dasar perhitungannya adalah pihak yang menagih, bukan kamu yang harus menebak."),
 ...
 ("Apa yang berada di luar pagar", [
  ...
  ("item", "Yang dicari", "nama badan hukumnya",
   "Yang dicocokkan bukan nama aplikasinya, melainkan nama badan hukum yang tertulis di kontrak. Keduanya sering berbeda, dan justru di celah itu banyak orang keliru merasa aman."),
  ...
  ("item", "Tanda kedua", "bunga yang tidak masuk akal",
   "Tanda kedua: bunga yang jauh di atas nol koma satu persen per hari, atau potongan di muka yang membuat dana yang cair jauh lebih kecil dari yang tertulis di kontrak."),
 ...
 ("Apa yang dilakukan dengan angka ini", [
  ...
  ("item", "Di mana mencarinya", "di mutasi rekening",
   "Angka itu ada di mutasi rekeningmu pada tanggal pencairan, dan itu bukti yang jauh lebih kuat daripada tampilan di dalam aplikasi."),
  ...
  ("titulo", "Simpan buktinya", "sebelum menghubungi siapa pun",
   "Sebelum menghubungi siapa pun, simpan tangkapan layar tagihan dan mutasinya. Percakapan tentang angka berjalan sangat berbeda ketika angkanya sudah tercatat."),
  ...
  ("item", "Contohnya", "satu juta menunggak vs lima juta lancar",
   "Utang satu juta yang menunggak berjalan dua ribu rupiah per hari. Utang lima juta yang lancar berjalan lima ribu. Yang kecil itu memakan hampir separuh dari yang besar, dengan seperlima nominalnya."),
