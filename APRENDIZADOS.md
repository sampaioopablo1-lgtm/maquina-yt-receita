...
Última sincronização: **2026-08-12** · 171 regras ativas, 44 críticas.
...
`aplicado_em:` (faltando — aplicado_em vazio no banco, id 144)
...
`aplicado_em:` (faltando — aplicado_em vazio no banco, id 123)
